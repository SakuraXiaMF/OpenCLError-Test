...
typedef struct decode_s
{
	...
	unsigned flags;
	__global void *emitfn;//int (*emitfn)(unsigned long next_eip, struct decode_s *ds,  unsigned char *bbOut, unsigned char *bbLimit);
	__global void *pEntry;
} decode_t;

//typedef int (*EMITFN)(unsigned long next_eip, struct decode_s *ds,unsigned char *bbOut, unsigned char *bbLimit);
